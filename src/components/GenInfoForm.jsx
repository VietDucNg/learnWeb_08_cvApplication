...
export default function GenInfoForm() {
                ...
                case 'phone':
                    ...
                    if (!value.match(/^\+?\d+$/)) {
                        ...
                        if (!value.match(/^\+\d/)) {
                            ...
                            error = 'When using international format (+), the first digit cannot be 0';
                        }
                    } else if (!value.match(/^0/)) {
    ...
    return (
        <form ref={formRef} onSubmit={handleSubmit} className="genInfo-form grid-row">
            ...
            <section className="field-div flex-column">
                ...
                onClick={(e) => setFocus(e, "name")} >
                    <IoPersonOutline />
                    <input type="text" id="name-input" placeholder="Viet Nguyen" name='name' value={values.name} onChange={handleChange} required/>
                </div>
            ...
            <section className="field-div flex-column">
                ...
                <div className={`input-div flex-row 
                    ...
                    <MdOutlineEmail />
                    <input type="email" id="email-input" placeholder="viet.nguyen@webdev.com" name='email' value={values.email} onChange={handleChange} required/>
                </div>
            ...
            <section className="field-div flex-column">
                ...
                <div className={`input-div flex-row 
                    ...
                    <FiPhone />
                    <input type="text" id="phone-input" placeholder="(+49) 123 456 7890" name='phone' value={values.phone} onChange={handleChange}/>
                </div>
